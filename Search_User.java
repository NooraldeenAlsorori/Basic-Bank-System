...
public class Search_User extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ادخل الرقم الوظيفي للبحث");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String s2 ="-";
        if (s1.equals("")) {
            JOptionPane.showMessageDialog(this, "لايوجد رقم للبحث عنه");
        }
         else{
                JOptionPane.showMessageDialog(this, "لايوجد قاعدة بيانات للبحث فيها");
